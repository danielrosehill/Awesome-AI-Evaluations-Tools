...
| [ClawBench](https://github.com/TIGER-AI-Lab/ClawBench) | Live-site benchmark for browser agents with isolated runs, 283 V1/V2 tasks, and five synchronized evidence layers. | ![](https://img.shields.io/github/stars/TIGER-AI-Lab/ClawBench?style=social) | ![](https://img.shields.io/github/last-commit/TIGER-AI-Lab/ClawBench) |
