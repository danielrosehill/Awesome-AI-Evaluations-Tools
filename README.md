...
| [TWZRD Agent Intel](https://intel.twzrd.xyz) | Trust scoring MCP server for AI agents. Verify agent wallet identity before accepting automated evaluation results — free `preflight_check()` + paid signed trust receipt via x402 micropayment. Solana on-chain audit trail for agent actions. | ![](https://img.shields.io/badge/live-blue) | ![](https://img.shields.io/badge/2026-blue) |
