...
| [agent-eval-kit](https://github.com/SeaOtterAI/agent-eval-kit) | SDK + MCP for a hostile-by-default critic (OtterScore) that grades agent work — output and trajectory — against your acceptance policy and gates it (ship / route / quarantine / block). | ![](https://img.shields.io/github/stars/SeaOtterAI/agent-eval-kit?style=social) | ![](https://img.shields.io/github/last-commit/SeaOtterAI/agent-eval-kit) |
